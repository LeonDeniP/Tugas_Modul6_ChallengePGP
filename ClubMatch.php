...
<html>
<head>
 <title>Current La Liga Result</title>
 <style>
 body {
...
<table>
 <tr>
 <th>Position</th>
 <td><?php echo $benzema->getClub()->getPosition(); 
?></td>
 </tr>
 <tr>
 <th>Points</th>
 <td><?php echo $benzema->getClub()->getPoints(); 
?></td>
 </tr>
 <tr>
 <th>Win</th>
 <td><?php echo $benzema->getClub()->getWins(); 
?></td>
 </tr>
 <tr>
 <th>Draw</th>
 <td><?php echo $benzema->getClub()->getDraw(); 
?></td>
 </tr>
 <tr>
 <th>Loses</th>
 <td><?php echo $benzema->getClub()->getLoses(); 
?></td>
 </tr>
</table>
